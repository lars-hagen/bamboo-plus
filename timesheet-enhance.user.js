// ==UserScript==
// @name         BambooHR Plus - Timesheet Autofill
// @namespace    http://tampermonkey.net/
// @version      0.4
// @description  Enhanced BambooHR experience - Timesheet autofill with smart defaults and improved UI
// @author       You
// @match        https://billwerk.bamboohr.com/employees/timesheet/*
// @grant        none
// ==/UserScript==
    ...
    settingsPanel.innerHTML = `
        <div style="padding: 8px 0;">
            ...
            <div class="fab-Checkbox">
                ...
                <div style="color: #666; font-size: 13px; margin: 2px 0 0 24px;">Always show the autofill controls at the bottom</div>
            </div>
        </div>`;
